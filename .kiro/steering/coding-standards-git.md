...
- Khi thêm env var mới, **phải cập nhật `.env.example`** với placeholder value
...
- Tag trên `main` sau khi merge và CI pass
- Tag message mô tả ngắn gọn nội dung release: `git tag -a v1.0.0 -m "Unit 1: Core Foundation"`
